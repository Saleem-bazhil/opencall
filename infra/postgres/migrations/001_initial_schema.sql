...
CREATE TABLE daily_call_plan_reports (
  ...
  renderways_upload_batch_id UUID NOT NULL REFERENCES source_upload_batches(id),
  call_plan_upload_batch_id UUID NOT NULL REFERENCES source_upload_batches(id),
